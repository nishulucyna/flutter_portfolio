            ...
            child: Column(
              ...
              children: [
                const ProjectCard(
                  ...
                  description:
                      'A machine learning system built during a hackathon to detect manipulated media. The project utilized datasets like LJSpeech and WaveFake to train temporal neural networks for highly accurate audio classification.',
                ),
                const SizedBox(height: 16),
                const ProjectCard(
                  title: 'Techfest PQC (Post-Quantum Cryptography)',
                  description:
                      'An exploration and implementation of post-quantum cryptographic algorithms designed to secure data against future quantum computing threats, developed for Techfest.',
                ),
                const SizedBox(height: 28),
                ElevatedButton(
                  onPressed: () => Navigator.pop(context),
